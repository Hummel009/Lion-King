...
| JDK        | 11.0.21 | Версия Java, используемая для запуска проекта |
| Java       | 6       | Синтаксис Java, используемый в проекте        |
...
* Запуск клиента из среды: `Меню Gradle -> volde.run -> runClient`.
