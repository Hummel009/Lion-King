...
public class LKTeleporter extends Teleporter {
	...
	public LKTeleporter(WorldServer world, boolean isPrideLands, List list) {
		super(world);
		worldObj = world;
		idFrame = isPrideLands ? LKMod.lionPortalFrame.blockID : LKMod.outlandsPortalFrame.blockID;
		idPortal = isPrideLands ? LKMod.lionPortal.blockID : LKMod.outlandsPortal.blockID;
		simbaData = list;
	...
	public void createLionPortal(Entity entity) {
		byte var2 = 16;
		double var3 = -1.0D;
