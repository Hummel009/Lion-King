...
public class LKBiomeDecorator {
	...
	public LKBiomeDecorator(LKPrideLandsBiome pridelandsbiome) {
		...
		coalGen = new LKWorldGenMinable(LKMod.prideCoal.blockID, 16);
		silverGen = new LKWorldGenMinable(LKMod.oreSilver.blockID, 6);
		peacockGen = new LKWorldGenMinable(LKMod.orePeacock.blockID, 6);
		...
		blueFlowerGen = new WorldGenFlowers(LKMod.blueFlower.blockID);
