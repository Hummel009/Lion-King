...
public abstract class LKEntityDart extends Entity {
	...
	public void setDartHeading(double d, double d1, double d2, float f, float f1) {
		...
		d1 /= f2;
		d2 /= f2;
		d += worldObj.rand.nextGaussian() * 0.0074999998323619366D * f1;
		d1 += worldObj.rand.nextGaussian() * 0.0074999998323619366D * f1;
		d2 += worldObj.rand.nextGaussian() * 0.0074999998323619366D * f1;
		d *= f;
		d1 *= f;
		d2 *= f;
		motionX = d;
		...
		prevRotationYaw = rotationYaw = (float) ((Math.atan2(d, d2) * 180.0D) / 3.1415927410125732D);
		prevRotationPitch = rotationPitch = (float) ((Math.atan2(d1, f3) * 180.0D) / 3.1415927410125732D);
		ticksInGround = 0;
	}
	...
	public void setVelocity(double d, double d1, double d2) {
		...
		if (prevRotationPitch == 0.0F && prevRotationYaw == 0.0F) {
			...
			prevRotationYaw = rotationYaw = (float) ((Math.atan2(d, d2) * 180.0D) / 3.1415927410125732D);
			prevRotationPitch = rotationPitch = (float) ((Math.atan2(d1, f) * 180.0D) / 3.1415927410125732D);
