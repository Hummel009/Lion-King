...
public enum LKCharacterSpeech {
	...
	private static class Speech {
		private static String[] morningReportSpeeches = {
		...
		private static String[] hyenaBonesSpeeches = {
		...
		private static String[] mentionScarSpeeches = {
		...
		private static String[] termitesSpeeches = {
		...
		private static String[] mangoesSpeeches = {
		...
		private static String[] starAltarSpeeches = {
		...
		private static String[] hintSpeeches = {
		...
		private static String[] flowerSpeeches = {
		...
		private static String[] bugsSpeeches = {
		...
		private static String[] moreBugsSpeeches = {
		...
		private static String[] rugScarSpeeches = {
		...
		private static String[] ziraIngotsSpeeches = {
		...
		private static String[] ziraFeathersSpeeches = {
		...
		private static String[] ziraConquestSpeeches = {
		...
		private static String[] rugZiraSpeeches = {
		...
		private static String[] lionSpeeches = {
		...
		private static String[] lionCubSpeeches = {
				"Roar!",
				"Grrr!",
				"Rrr!"
		};

		private static String[] zebraSpeeches = {
		...
		private static String[] zebraFoalSpeeches = {
				"Hmmph!",
				"Hssh!",
				"Hmm!"
		};

		private static String[] rhinoSpeeches = {
		...
		private static String[] rhinoCalfSpeeches = {
				"Rrr!",
				"Hmm!",
				"Hrrh!"
		};

		private static String[] gemsbokSpeeches = {
		...
		private static String[] gemsbokCalfSpeeches = {
				"Hmmph!",
				"Hssh!",
				"Hmm!"
		};
