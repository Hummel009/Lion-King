...
import lionking.client.effect.LKEntityPassionFX;
import lionking.client.effect.LKEntityPortalFX;
import lionking.client.model.*;
import lionking.client.render.*;
import lionking.client.render.tileentity.LKTileEntityBugTrapRenderer;
import lionking.client.render.tileentity.LKTileEntityHyenaHeadRenderer;
import lionking.client.render.tileentity.LKTileEntityMobSpawnerRenderer;
import lionking.client.render.tileentity.LKTileEntityMountedShooterRenderer;
import lionking.common.LKCommonProxy;
import lionking.common.LKMod;
import lionking.common.LKTickHandlerServer;
import lionking.common.entity.*;
import lionking.common.tileentity.*;
...
public class LKClientProxy extends LKCommonProxy {
	...
	private ITickHandler tickHandler = new LKTickHandlerClient();
	private IPacketHandler clientHandler = new LKPacketHandlerClient();
	...
	public void onLoad() {
		...
		RenderingRegistry.registerEntityRenderingHandler(LKEntityThrownTermite.class, new RenderSnowball(LKMod.itemTermite));
		...
		RenderingRegistry.registerEntityRenderingHandler(LKEntityPumbaaBomb.class, new RenderSnowball(LKMod.pumbaaBomb));
		...
		RenderingRegistry.registerEntityRenderingHandler(LKEntityZazuEgg.class, new RenderSnowball(LKMod.zazuEgg));
		...
		MinecraftForgeClient.registerItemRenderer(LKMod.tunnahDiggah.itemID, new LKRenderLargeItem());
	}
